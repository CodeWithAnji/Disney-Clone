...
function Slider() {
  ...
  const sliderLeft=(element)=>{
    ...
    return (
     ...
     mx-8 mt-[150px] cursor-pointer bg-transparent' onClick={()=>sliderLeft(elementRef.current)}/>
            <HiChevronRight className='hidden md:block text-white text-[30px] absolute
     mx-8 mt-[150px] cursor-pointer right-0 bg-transparent' onClick={()=>sliderRight(elementRef.current)}/>
